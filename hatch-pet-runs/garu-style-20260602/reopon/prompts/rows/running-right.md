Create one horizontal animation strip for Codex pet `reopon`, state `running-right`.
...
Identity: same pet in every frame: pink lion cub mascot with fluffy rounded mane, cream muzzle and belly, tiny tail tuft. Reference style lock: soft pastel pink base, deep rose thick rounded outlines, huge glossy round eyes with white star highlights, rosy cheeks, cream-white muzzle/chest/belly accents, plush baby proportions, cute front-facing mascot, clean whole-body sprite, no black background, no shadow.. Japanese display concept: れおぽん: ふわふわのたてがみがハートみたいなライオン。勇気をくれるけれど声はとてもやさしい。. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
