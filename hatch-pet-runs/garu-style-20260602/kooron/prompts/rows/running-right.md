Create one horizontal animation strip for Codex pet `kooron`, state `running-right`.
...
Identity: same pet in every frame: cute pink cricket mascot with short antennae, rounded hind legs, cream belly, no sharp insect realism. Reference style lock: soft pastel pink base, deep rose thick rounded outlines, huge glossy round eyes with white star highlights, rosy cheeks, cream-white muzzle/chest/belly accents, plush baby proportions, cute front-facing mascot, clean whole-body sprite, no black background, no shadow.. Japanese display concept: こおろん: ちいさなコオロギ。音符のかわりにぴょんぴょん跳ねて、夜の作業を静かに応援する。. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
