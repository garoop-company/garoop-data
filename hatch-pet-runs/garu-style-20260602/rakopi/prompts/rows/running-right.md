Create one horizontal animation strip for Codex pet `rakopi`, state `running-right`.
...
Identity: same pet in every frame: pink sea otter mascot holding a small shell attached to body, cream muzzle and belly, rounded tail. Reference style lock: soft pastel pink base, deep rose thick rounded outlines, huge glossy round eyes with white star highlights, rosy cheeks, cream-white muzzle/chest/belly accents, plush baby proportions, cute front-facing mascot, clean whole-body sprite, no black background, no shadow.. Japanese display concept: らこぴ: 貝をだっこするラッコ。お気に入りを大切にしまう、ぷかぷか気分の癒し係。. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
