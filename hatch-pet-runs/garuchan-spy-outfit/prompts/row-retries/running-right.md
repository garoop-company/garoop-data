Create Codex pet row `running-right` for `garuchan-spy-outfit`: exactly 8 full-body frames in one horizontal strip on flat pure cyan #00FFFF.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: ピンクの大きな耳と大きな瞳を持つかわいいガルちゃん。お腹のポーチに赤ちゃんがいる。黒いスパイ衣装、黒いサングラス、小さな映画小道具風ピストルを下向きに持つ。小道具は非写実的で発射しない。. Preserve silhouette, face, palette, material, proportions, markings, and props.
